...
function seoHead(array $config = []): string {
    $defaults = [
        ...
        'keywords' => 'indonesia data, open data, umr, minimum wage indonesia, living cost, food prices, economic statistics, bps, kemnaker, cost of living indonesia',
        'keywords_id' => 'data indonesia, open data, umr, biaya hidup, harga pangan, statistik ekonomi, bps, kemnaker',
